...
public class ExperimentECJ_PSO {
	...
	public static String problem_1 = "RastriginEEstatPSO_a";
	...
	public static void main(String[] args) {
		setArrays(dir, 1);
		int problemDimension = 30;
		epsilon = Util.generateEpsilonVector(problemDimension, 0.3); //for binary vector is any value less than 1 ok!
		int number_of_test_repetition =2;
		int x=5; //X dimension-s is/are changed by epsilon
		problemFiles = new String[2];
